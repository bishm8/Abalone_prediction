# -*- coding: utf-8 -*-
"""Abalone_Predictions.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Guz3FcRWZPR47w-mvHt5kMLBgYKIZZ3t
...
df=pd.read_csv('abalone.data',sep=',',names=col)
df.head()
...
# Height can't have 0 hence replacing it with mean
df[df['Height'] == 0]['Height'].count()

fillzero=df['Height'].mean()
df["Height"] = df["Height"].mask(df["Height"] == 0, fillzero)
...
df = df.drop(['Diameter', 'Shucked_weight'], axis=1)
df.shape
...
rfc = RandomForestClassifier(n_trees=30, bootstrap=True, max_features=7, min_samples_leaf=9,random_state=1)
...
x=[[0.455,	0.095,	0.5140,	0.1010,	0.150,	0,1]]
